...
public:
    ...
    virtual bool IsOverflow(int64_t max_dutation);
...
public:
    ...
    virtual int OnAudio(rtmp::SharedPtrMessage *share_audio) override;
...
public:
    ...
    virtual int OnMetadata(rtmp::SharedPtrMessage *shared_metadata);
    virtual int OnAudio(rtmp::SharedPtrMessage *share_audio);
    virtual int OnVideo(rtmp::SharedPtrMessage *shared_video) ;
